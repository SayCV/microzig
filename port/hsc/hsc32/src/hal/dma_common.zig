...
// dma_v3 and  v2 has the same cluster definition
// Type would coerce.
const dma_v3 = microzig.chip.types.peripherals.dma_v3;

const PriorityLevel = dma_v3.PL;
const Direction = dma_v3.DIR;
const Size = dma_v3.SIZE;
const CH = dma_v3.CH;
